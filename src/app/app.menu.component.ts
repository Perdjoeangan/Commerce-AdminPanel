        ...
        this.model = [
            {
                ...
                items:[
                    ...
                    {label: 'Campaigns', icon: 'pi pi-fw pi-send'},
                    {label: 'Subscriptions', icon: 'pi pi-fw pi-dollar'},
                    {label: 'Complaints', icon: 'pi pi-fw pi-comment'},
                    {label: 'System', icon: 'pi pi-fw pi-server'},
                ]
            },
            {
                label: 'Management',
